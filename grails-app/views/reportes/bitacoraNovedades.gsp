...
<div class="container-fluid">
    <g:form action = "bitacoraNovedades" class="col-lg-12">
        ...
        <div class="col-lg-12 form-group">
            ...
            <g:select class="form-control" name="nombreBase" multiple="true" size="25" required="" from="${utilitarios.Util.getNombresBaseNovedades()}"></g:select>
        </div>
        <div class="col-lg-12">
