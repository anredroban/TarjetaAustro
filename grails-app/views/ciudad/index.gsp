		...
		<div id="list-ciudad" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="estado" title="${message(code: 'ciudad.estado.label', default: 'Estado')}" />
					
						<g:sortableColumn property="nombre" title="${message(code: 'ciudad.nombre.label', default: 'Nombre')}" />
					
						<th><g:message code="ciudad.provincia.label" default="Provincia" /></th>
				...
				<g:each in="${ciudadInstanceList}" status="i" var="ciudadInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${ciudadInstance.id}">${fieldValue(bean: ciudadInstance, field: "estado")}</g:link></td>
					
						<td>${fieldValue(bean: ciudadInstance, field: "nombre")}</td>
					
						<td>${fieldValue(bean: ciudadInstance, field: "provincia.nombre")}</td>
			...
			<div class="pagination">
				<g:paginate total="${ciudadInstanceCount ?: 0}" />
			</div>
		</div>
	</body>
</html>
