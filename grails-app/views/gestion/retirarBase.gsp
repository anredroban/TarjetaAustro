                            ...
                            <div class="panel-body">
                                <div class="table-responsive">
	                                <g:form action="retirarBase">
	                                	...
	                                	<div class="col-lg-3">
	                                		<strong>Tipo: </strong>
	                                		<g:select name="tipo" from="${['REGESTIONABLE', 'SIN GESTION', 'RELLAMADAS']}" noSelection="${['': 'TODOS']}"></g:select>
	                                	</div>
										<div class="col-lg-3">
											<strong>Cod desde: </strong>
											<g:textField name="desde"></g:textField>
										</div>
										<div class="col-lg-3">
											<strong>Cod hasta: </strong>
											<g:textField name="hasta"></g:textField>
										</div>
