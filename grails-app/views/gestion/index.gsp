...
<title>Adicionales Austro - Gestión</title>
		...
		<div class="nav" role="navigation">
			...
			<thead>
					<tr>
						...
						<%--<g:sortableColumn property="descripcion" title="${message(code: 'gestion.descripcion.label', default: 'Apellidos')}" />--%>
				...
				<g:each in="${clientesGestionar}" status="i" var="cliente">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<%--<td><g:link action="gestionCliente" class="linkcliente" id="${cliente.id}">${fieldValue(bean: cliente, field: "apellidos")}</g:link></td>--%>
